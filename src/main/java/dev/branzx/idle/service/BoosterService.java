...
public final class BoosterService {
    ...
    public BoosterService(IdlePlugin plugin, Database database, PlayerDataStore dataStore) {
        this.plugin = plugin;
    ...
    public void loadAllSync() {
        try (Connection connection = database.getConnection();
             PreparedStatement select = connection.prepareStatement(
                     "SELECT owner_uuid, booster_type, multiplier, expires_at FROM idle_boosters");
    ...
    public String buy(UUID owner, String type) {
        ...
        boolean committed = database.executeTransaction("buy booster " + owner + " " + type,
            ...
            try (PreparedStatement upsert = connection.prepareStatement(
                         "REPLACE INTO idle_boosters (owner_uuid, booster_type, multiplier, expires_at) "
                                 + "VALUES (?, ?, ?, ?)")) {
