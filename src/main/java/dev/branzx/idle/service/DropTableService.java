...
public final class DropTableService {
    ...
    public DropTableService(IdlePlugin plugin) {
        this.plugin = plugin;
    ...
    private String resourceCap(String resource) {
        ...
        if (dev.branzx.idle.service.design.RareResources.DAILY.contains(normalized)) {
            return "ACCOUNT_DAILY_RARE_CAP";
        }
        if (dev.branzx.idle.service.design.RareResources.WEEKLY.contains(normalized)) {
