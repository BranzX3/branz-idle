...
public final class NodeAnchorStore {
    ...
    public NodeAnchorStore(IdlePlugin plugin, Database database) {
        this.plugin = plugin;
        ...
        database.submitWrite(() -> {
            try (Connection connection = database.getConnection();
                 PreparedStatement upsert = connection.prepareStatement(
                         "REPLACE INTO idle_worker_anchors (worker_uuid, node_id, spawn_x, spawn_y, "
        ...
        database.submitWrite(() -> {
            try (Connection connection = database.getConnection();
                 PreparedStatement delete = connection.prepareStatement(
                         "DELETE FROM idle_worker_anchors WHERE worker_uuid = ?")) {
    ...
    public void clearNode(long nodeId) {
        ...
        database.submitWrite(() -> {
            try (Connection connection = database.getConnection();
                 PreparedStatement delete = connection.prepareStatement(
                         "DELETE FROM idle_worker_anchors WHERE node_id = ?")) {
